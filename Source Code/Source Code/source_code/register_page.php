...
<body>
    <div class="container">
        ...
        <form id="loginForm">
            ...
            <input type="text" id="username" placeholder="Enter a First Name" name="username" required>
			
			<label for="username">Last Name</label>
            <input type="text" id="username" placeholder="Enter a Last Name" name="username" required>
			
			<label for="username">Email-id</label>
            <input type="text" id="username" placeholder="Enter a Email-id" name="username" required>

            <label for="password">Password</label>
            <input type="password" id="password" placeholder="Enter a Password" name="password" required>
			
			<label for="username">Confirm password</label>
            <input type="text" id="username" placeholder="Enter a Confirm password" name="username" required>
